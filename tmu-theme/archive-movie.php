 ...
 * 
 * Template for displaying movie archive/listing pages
 * 
 * @package TMU
 * @since 1.0.0
 */
...
<div class="tmu-movie-archive bg-gray-50 min-h-screen">
    <!-- Archive Header -->
        ...
        <div class="tmu-container py-8">
            ...
            <div class="mt-6">
                <h1 class="text-4xl font-bold text-gray-900 mb-2">
                    <?php
                    if ($current_search) {
                        printf(__('Movies: Search results for "%s"', 'tmu-theme'), esc_html($current_search));
                    } elseif ($current_genre) {
                        $genre_term = get_term_by('slug', $current_genre, 'genre');
                        if ($genre_term) {
                            printf(__('Movies: %s', 'tmu-theme'), esc_html($genre_term->name));
                        }
                    } elseif ($current_year) {
                        printf(__('Movies: %s', 'tmu-theme'), esc_html($current_year));
                    } else {
                        _e('All Movies', 'tmu-theme');
                    }
                    ?>
                </h1>
                ...
                <p class="text-gray-600">
                    ...
                    printf(
                        _n('%s movie found', '%s movies found', $total, 'tmu-theme'),
                        number_format($total)
                    );
                    ?>
                </p>
            ...
            <div class="lg:flex lg:gap-8">
                ...
                <aside class="lg:w-1/4 mb-8 lg:mb-0">
                    <div class="bg-white rounded-lg shadow-sm p-6 sticky top-8">
                        <h2 class="text-xl font-semibold mb-6"><?php _e('Filter Movies', 'tmu-theme'); ?></h2>
                        ...
                        <div class="mb-6">
                            ...
                            <form method="get" action="<?php echo esc_url(get_post_type_archive_link('movie')); ?>">
                                <div class="flex">
                                    <input type="text" 
                                           name="s" 
                                           value="<?php echo esc_attr($current_search); ?>" 
                                           placeholder="<?php esc_attr_e('Search movies...', 'tmu-theme'); ?>"
                        ...
                        <div class="mb-6">
                            ...
                            <select id="sort-filter" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                                ...
                                <option value="release_date" <?php selected($current_sort, 'release_date'); ?>><?php _e('Release Date', 'tmu-theme'); ?></option>
                ...
                <main class="lg:w-3/4">
                    ...
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <div class="text-sm text-gray-600">
                            <?php
                            printf(
                                __('Showing %d-%d of %d movies', 'tmu-theme'),
                    ...
                    <?php if (have_posts()): ?>
                        <!-- Grid View -->
                        <div id="movies-grid" class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mb-8">
                        ...
                        <div id="movies-list" class="space-y-6 mb-8 hidden">
                            <?php 
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <div class="flex items-center space-x-4 text-sm text-gray-600 mb-3">
                                            ...
                                            <?php if (!empty($movie_data['vote_average'])): ?>
                                                <div class="flex items-center">
                                                    ...
                                                    <span class="ml-1"><?php echo number_format((float) $movie_data['vote_average'], 1); ?></span>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                        ...
                                        <?php if (!empty($movie_data['overview'])): ?>
                                            <p class="text-gray-700 mb-4">
                                                <?php echo esc_html(tmu_truncate_text($movie_data['overview'], 200)); ?>
                                            </p>
                                        <?php endif; ?>
                    ...
                    <?php else: ?>
                        ...
                        <div class="text-center py-12">
                            ...
                            <h2 class="text-2xl font-bold text-gray-900 mb-4"><?php _e('No movies found', 'tmu-theme'); ?></h2>
                            <p class="text-gray-600 mb-8"><?php _e('Try adjusting your search criteria or browse all movies.', 'tmu-theme'); ?></p>
                            <a href="<?php echo esc_url(get_post_type_archive_link('movie')); ?>" 
                               class="px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
                                <?php _e('View All Movies', 'tmu-theme'); ?>
                            </a>
                        </div>
                    <?php endif; ?>
                </main>
